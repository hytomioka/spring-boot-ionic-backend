...
import com.tomioka.cursomc.services.ClienteService;
...
public class ClienteResource {
	...
	// Método PUT atualiza uma informação
		...
		public ResponseEntity<Page<ClienteDTO>> fingPage(
			...
			Page<ClienteDTO> listDto = list.map(obj -> new ClienteDTO(obj)); // Page<> é do java 8, portanto não há necessidade 
